          ...
          {offer ? (
            <>
              <div className={styles.Offer}>
                ...
                <li>
                  <b>Weekend Morning</b>: 18th February, 8 AM to 11 AM
                </li>
                {/* <li><b>{batch3}</b>{batch33}</li> */}
                <p style={{ fontSize: "12px" }}>*Terms & Conditions applied.</p>
                <a href="/submit-info" target="_blank">
            ...
            <>
              ...
              <div className={styles.Offer}>
                <h6>
                  Special programming session starts from 14th to 16th February from
                  8AM to 10AM
                </h6>
            ...
            : 9th October, 08:30 AM to 12 PM
                ...
                <li>
                  <b>Weekday Evening</b>: 24th February, 8 PM to 10 PM
                </li>
                <li>
                  <b>Weekend Morning</b>: 26th February, 08:30 AM to 12 PM
                </li>
                {/* <li><b>{batch3}</b>{batch33}</li> */}
                <p style={{ fontSize: "12px" }}>*Terms & Conditions applied.</p>
                <a href="/submit-info" target="_blank">
