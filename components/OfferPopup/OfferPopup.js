  ...
  return (
    ...
    <div className={open ? styles.OfferPopup : styles.hide} >
      ...
      <div className={styles.Offer}>
        ...
        <li>
          <b>Weekday Evening</b>
          : 20th January (SD), 8 PM to 10 PM
        </li>
        <li>
          <b>Weekend Evening</b>
          : 22nd January (SD), 12:30 PM to 4 PM
        </li>
        ...
        <a href="/submit-info" target="_blank">
          <button onClick={handelOpen} style={{ width: "100%" }}>
            ...
            <>
              {" "} 
      <div className={styles.Offer}>
        <h6>Special programming session starts from 24th to 26th January from 8PM to 10PM</h6>
        ...
        <li>
          <b>Weekday Evening</b>
          : 27th January, 8 PM to 10 PM
        </li>
        <li>
          <b>Weekend Morning</b>
          : 29th January, 08:30 AM to 12 PM
        </li>
        {/* <li><b>{batch3}</b>{batch33}</li> */}
        <p style={{ fontSize: "12px" }}>*Terms & Conditions applied.</p>
        <a href="/submit-info" target="_blank">
