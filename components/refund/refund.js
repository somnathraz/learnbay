...
<p className={styles.bot}>4. If a user violates any terms and conditions listed on the Learnbay website and leaves the course/ or Learnbay ceases his/her access.</p>
...
<p className={styles.bot}>7. If candidates have not submitted the required documents for application completion even after 3 successive notices and Learnbay has to cease her/his LMS access.</p>
