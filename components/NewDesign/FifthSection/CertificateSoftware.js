...
import {
  CertificateSoftware1,
  CertificateSoftware2,
          ...
          {IActive ? (
            <>
              <div className={styles.gridPanel}>
                {CertificateSoftware1.map((CertificateSoftware2ata) => {
                  const { id, title, img, para } = CertificateSoftware2ata;
                  return (
        ...
        <div className={MActive ? styles.certificateS : styles.certificate}>
          ...
          {IActive ? (
            <>
              ...
              <div className={styles.gridPanel}>
                {CertificateSoftware2.map((CertificateSoftware2ata) => {
                  const { id, title, img, para } = CertificateSoftware2ata;
                  return (
                    <div className={styles.leftSide} key={id}>
                      <div className={styles.leftSideP} key={id}>
