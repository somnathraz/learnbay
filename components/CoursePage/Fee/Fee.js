      ...
      {changeFee ? (
        <div className={styles.priceTableData}>
          ...
          >
            ...
            <span className={styles.PFeatures}>{PFeatures16}</span>
            <span className={styles.PFeatures}>{PFeatures17}</span>
          ...
          >
            ...
            <span className={styles.PFeatures}>{PFeatures26}</span>
            <span className={styles.PFeatures}>{PFeatures27}</span>
          ...
          >
            ...
            <span className={styles.PFeatures}>{PFeatures36}</span>
            <span className={styles.PFeatures}>{PFeatures37}</span>
        ...
        <div className={styles.priceTable}>
          ...
          <div className={hover ? styles.third : styles.fourth}>
            <span className={styles.sub}>{sub2}</span>
            <span className={styles.Price}>{Price2}</span>
            <span className={styles.PFeatures}>{PFeatures21}</span>
            <span className={styles.PFeatures}>{PFeatures22}</span>
