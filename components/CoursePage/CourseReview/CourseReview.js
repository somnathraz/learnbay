...
const CourseReview = () => {
  ...
  return (
    ...
    <div className={styles.bottomReview}>
            ...
            <Image src="/Hiring-partner-review.png"  width="1603" height="82" layout="intrinsic"/>
            <button>Download Placement Report <MdKeyboardArrowDown/></button>
        </div>
    </>
