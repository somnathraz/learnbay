...
import { Certificate11, Certificate12 } from "./CertificateDetail";
    ...
    <section className={styles.CertificateTab}>
      <div className={styles.certificate}>
        <div className={styles.gridPanel}>
          {Certificate11.map((Certificate12ata) => {
            const { id, title, img, para } = Certificate12ata;
            return (
        ...
        <div className={styles.gridPanel}>
          {Certificate12.map((Certificate12ata) => {
            const { id, title, img, para } = Certificate12ata;
            return (
              <div className={styles.leftSide} key={id}>
                <div className={styles.leftSideP} key={id}>
