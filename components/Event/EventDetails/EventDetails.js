    ...
    <div className={styles.Main}>
      <div className={styles.left}>
        <div className={styles.leftI}>
          {mobile ? (
            <Image src={img1} width="25" height="25" layout="intrinsic"  alt="data science course"/>
          ) : (
      ...
      <div className={styles.middle}>
        <div className={styles.leftI}>
          {mobile ? (
            ...
            <Image src={img2} width="45" height="45" layout="intrinsic"  alt="data science course"/>
          )}
        </div>
        <div className={styles.rightI}>
          <h6>{secondH}</h6>
      ...
      <div className={styles.right}>
        <div className={styles.leftI}>
          {mobile ? (
            ...
            <Image src={img3} width="45" height="45" layout="intrinsic"  alt="data science course"/>
          )}
        </div>
        <div className={styles.rightI}>
          <h6>{thirdH}</h6>
