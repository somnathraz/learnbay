  ...
  },
  {
    ...
    ans: (
      <sapn>
        ...
        <span>• Bit manipulation</span> <br />
        <span>• Two pointers</span> <br />
        <span>• Sorting </span> <br />
        <span>• Strings </span> <br />
        <span>• Array</span> <br />
        <span>• Linked lists</span> <br />
        <span>• Stack </span> <br />
        <span>• Queue </span> <br />
        <span>• Maths</span> <br />
        <span>• Advanced analysis of algorithms </span> <br />
        <span>• Advanced data structure </span> <br />
        <span>• Analysis of algorithms </span> <br />
        <span>• System design principles</span> <br />
        <span>• System design patterns</span> <br />
        <span>• Low-level & high-level designs </span> <br />
...
export const MentorshipFaqData9 = [
  ...
  {
    id: 3,
    ques: "How long can I avail the facility of mentorship?",
    ans: "Our Mentors will provide DSA training to the learners until the completion of the course. Next, during the job placement programs, a learner can opt for doubt-clearing sessions where mentorship is required. After completion of each task, assessment, and project work, mentorship ends.",
    open: false,
  },
