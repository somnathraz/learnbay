...
import { FaqData, DomainFaqData } from "../components/FAQ/FaqData";
      ...
      <main>
        ...
        <div className={styles.cta}>
          ...
          <div className={styles.middle}>
            <p>
              Doubts Regarding Learning Assistance? Or You’re Unsure Of Your
              Initial Data Science Career Step? Whatever Is It…
            </p>
        ...
        <CourseFee />
        <ReferSection />
        <FAQNew FaqDatas={FaqData} DomainFaqDatas={DomainFaqData} />
      </main>
    </div>
  );
}
