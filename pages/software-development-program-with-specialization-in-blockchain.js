    ...
    <>
      ...
      <main>
        ...
        <FirstSection
          ...
          firstToparaImg="Specialization in Blockchain"
          firstHeading="Software Development Program with"
          firstTopPara="A redefined learning model for today's working professionals"
        />
        <SecondSection
          fullStackReview={true}
          SecondHead="What makes us your first choice!"
          SecondPara="Boost your career with blockchain program & confidently bag your dream job"
        ...
        <ThirdSection
          ...
          BatchPara="The pie-chart representation here shows that the Software Development Program with Specialization in Blockchain is suitable for people coming from the following industries and designation:"
          BatchParaImg1="https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/NewDesignImage/Blockchain+Left+Graph.png"
          BatchParaImg2="https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/NewDesignImage/Blockchain+Right+Graph.png"
          dataScience={true}
