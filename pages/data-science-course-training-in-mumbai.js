...
"url": "https://www.learnbay.co"
        ...
        <div className="MainCities">
          ...
          <div className="CitiesRight">
            <CitiesRight
              ...
              ProgramBot31="Our data science courses are designed to help working professionals achieve a successful and ever-growing career transition."
              ...
              ProgramBot6="With such an affordable and cost-effective course, you get flexible learning hours with our trainers and learners."
              ...
              ProgramBot105="All the data science courses are perfectly built with custom-fit modules, which have great relevance in enhancing and upgrading your career."
              ...
              ModuleBot45="5. This module (0) deals with a few terminologies in statistics such as (Mean, Median, Mode Standard Deviation, Average, Probability, permutations, and combinations. Introduction to Linear Algebra)"
    ...
    12+ Classes"
              ...
              JobBot3="Job assistance program helps in interview preparation through mock interviews and tests. Apart from that, the top instructor from Learnaby helps in the preparation of a proficient portfolio and CV that allows learners to achieve satisfactory results in data science interviews."
              JobBot4="Learnbay has partnered with 250+ companies that include top MNCs and startups across the globe. Additionally, we have a dedicated placement cell that helps in prioritizing the smooth career transition for working professionals. Because of Leanbay’s job assistance program, most of the successful alumni are hired in their desired firm one month prior to course completion."
              ...
              ProjectsBot2="In addition to that, Learnabay has introduced its own project innovation lab that can help the learner to understand the projects with ease."
