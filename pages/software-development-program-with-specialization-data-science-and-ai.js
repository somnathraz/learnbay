...
function blockchain() {
  ...
  return (
    <>
      <Head>
        <title>
          Software Development Program with Specialization in Data Science and AI
        </title>
        <meta name="robots" content="index, follow"/>
        <meta
          name="description"
          content="Software Development Program with Specialization in Data Science and AI"
        />
        <meta
          name="keywords"
          content="Software Development Program with Specialization in Data Science and AI"
      ...
      <main>
        ...
        <FirstSection
          ...
          firstToparaImg="Specialization in Data Science and AI"
          firstHeading="Software Development Program with"
          firstTopPara="Take the first step on your data science & AI journey with our expert-led"
        />
        <SecondSection
          fullStackReview={true}
          SecondHead="What makes us your first choice!"
          SecondPara="Boost your career with Data Science and AI program & confidently bag your dream job"
        ...
        <ThirdSection
          ...
          BatchPara="The pie-chart representation here shows that the Software Development Program with Specialization in Data Science and AI is suitable for people coming from the following industries and designation:"
          BatchParaImg1="https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/NewDesignImage/DSAI+SW+dev+Left.png"
          BatchParaImg2="https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/NewDesignImage/DSAI+SW+dev+Right.png"
          dataScience={true}
        ...
        />
        <SixthSection
          SpecDSAIProject={true}
          CourseFeeHead=" Data Science and AI : Batch Details"
          FullStack={true}
        />
        <FAQNew
          FaqDatas={FaqData2}
