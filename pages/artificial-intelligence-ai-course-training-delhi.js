...
import { ArtificialFaqDataD, ArtificialDomainFaqDataD, ArtificialPaymentFaqDataD, ArtificialCapstoneFaqDataD, ArtificialCertificationFaqDataD, ArtificialjobFaqDataD, ArtificialMentorshipFaqDataD, ArtificialSupportFaqDataD } from "../components/FAQ/FaqDataCity";
...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
      <title>Artificial Intelligence Course in Delhi | Artificial Intelligence Training in Delhi</title>
<meta name="description" content="Artificial Intelligence Course in Delhi. Learnbay is Advanced Artificial Intelligence Course Training Institute in Delhi. Artificial Intelligence course in Delhi will enhance your career" />
<meta name="Keywords" content="Artificial Intelligence course in Delhi, Artificial Intelligence training in Delhi, Artificial Intelligence institute in Delhi, best Artificial Intelligence institute in Delhi, Artificial Intelligence course in Delhi, Artificial Intelligence certification in Delhi, Artificial Intelligence training institute in Delhi, advanced Artificial Intelligence course in Delhi, Artificial Intelligence course with placement guarantee, Artificial Intelligence course" />
<link rel="canonical" href="https://www.learnbay.co/artificial-intelligence-ai-course-training-delhi" />
...
<meta name="robots" content="ALL" />
    ...
    Alumnip4="The best in Industry offerings from both cost and curriculum wise. One advantage of joining here is you can access their resources for a lifetime, unlike others where you have accessibility only for a year or so. Most importantly, there is continuous assistance for recruitment."
          ...
          />
            <FAQNew FaqDatas={ArtificialFaqDataD} DomainFaqDatas={ArtificialDomainFaqDataD} PaymentFaqDatas={ArtificialPaymentFaqDataD} CapstoneFaqDatas={ArtificialCapstoneFaqDataD} CertificationFaqDatas={ArtificialCertificationFaqDataD} jobFaqDatas={ArtificialjobFaqDataD} MentorshipFaqDatas={ArtificialMentorshipFaqDataD} SupportFaqDatas={ArtificialSupportFaqDataD} />
        </div>
      </div>
      <CityText
