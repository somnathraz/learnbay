  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://www.learnbay.co/datascience/best-data-science-courses-in-india"
        />
        ...
        <div className="MainCities">
          ...
          <div className="CitiesRight">
            <CitiesRight
              ...
              ProgramBot5="When it comes to the best data science courses in India, the essential factor to consider is affordability and assurance. Being the second most populated country, the Indian job market is extremely competitive. Learnbay provides the best and most affordable data science courses in India, with excellent Job Assistance assistance (interview assurance) and globally recognized certification. So, at the end of the course, you are bound to stay under the spotlight of the current job market skill demand."
              ProgramHead6="Personalized 1:1 attention:"
              ProgramBot6="Additionally, We offer peer-to-peer discussion and Doubt Clearing Sessions with experienced PRODUCT Based Companies data scientists."
