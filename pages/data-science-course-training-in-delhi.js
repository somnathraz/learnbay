 ...
 "organizer": {
  ...
  "url": "https://www.learnbay.co"
        ...
        <div className="MainCities">
          ...
          <div className="CitiesRight">
            <CitiesRight
              ...
              ProgramBot32="Data science course training in Delhi fees offered by Learnbay is from 65K to 1.2 lakh INR. The data science training schedules are flexible, and you can enroll in any batch or with any trainer. You can even attend multiple sessions with different instructors. One-on-one live doubt clearing sessions with seasoned MAANG Data scientists are included in our Data Science and Artificial Intelligence courses. Students can take a break after enrolling, then return to finish their studies in one to three years (depending on the course)."
              ...
              CertificationBot1="You may take advantage of live lessons with different instructors through Learnbay's IBM Data Scientist Course without dealing with any difficulties. Aside from that, you'll get IBM certifications for several data sciences and AI micro-skills. As a result, it's essentially a data science course with a 100% job assistance. You will receive 1 to 8 certifications depending on the course you choose. The best thing is that you will receive an IBM Project Experience Certificate once you finish the capstone project related to Delhi's Data Science and AI course. For additional information about micro-skill certificates, please see the course brochures."
    ...
    12+ Classes"
              ...
              JobBot2="All of our data science courses come with a guarantee of an interview with a prominent MNC or a rising startup in Delhi or India. However, if you enroll in a Data Science program with a 100% job assistance, you can get a refund if you don't get hired (which is very rare in Learnbay). More than 10000 Learnbay alumni are proudly employed in various data science positions throughout Delhi."
