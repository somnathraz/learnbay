...
import { ArtificialFaqDataCa, ArtificialDomainFaqDataCa, ArtificialPaymentFaqDataCa, ArtificialCapstoneFaqDataCa, ArtificialCertificationFaqDataCa, ArtificialjobFaqDataCa, ArtificialMentorshipFaqDataCa, ArtificialSupportFaqDataCa } from "../components/FAQ/FaqDataCity";
...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
      <title>Artificial Intelligence Course in Canada | Artificial Intelligence Training in Canada</title>
<meta name="description" content="Artificial Intelligence Course in Canada. Learnbay is Advanced Artificial Intelligence Course Training Institute in Canada. Artificial Intelligence course in Canada will enhance your career" />
<meta name="Keywords" content="Artificial Intelligence course in Canada, Artificial Intelligence training in Canada, Artificial Intelligence institute in Canada, best Artificial Intelligence institute in Canada, Artificial Intelligence course in Canada, Artificial Intelligence certification in Canada, Artificial Intelligence training institute in Canada, advanced Artificial Intelligence course in Canada, Artificial Intelligence course with placement guarantee, Artificial Intelligence course" />
<link rel="canonical" href="https://www.learnbay.co/artificial-intelligence-ai-course-training-canada" />
<meta name="robots" content="NOODP,NOYDIR" />
<meta name="HandheldFriendly" content="true" />
<meta name="distribution" content="global" />
<meta name="copyright" content="Learnbay: Artificial Intelligence Courses Certification Training Canada" />
...
<meta name="robots" content="ALL" />
    ...
    Alumnip4="The best in Industry offerings from both cost and curriculum wise. One advantage of joining here is you can access their resources for a lifetime, unlike others where you have accessibility only for a year or so. Most importantly, there is continuous assistance for recruitment."
          ...
          />
            <FAQNew FaqDatas={ArtificialFaqDataCa} DomainFaqDatas={ArtificialDomainFaqDataCa} PaymentFaqDatas={ArtificialPaymentFaqDataCa} CapstoneFaqDatas={ArtificialCapstoneFaqDataCa} CertificationFaqDatas={ArtificialCertificationFaqDataCa} jobFaqDatas={ArtificialjobFaqDataCa} MentorshipFaqDatas={ArtificialMentorshipFaqDataCa} SupportFaqDatas={ArtificialSupportFaqDataCa} />
        </div>
      </div>
      <CityText
