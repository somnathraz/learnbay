        ...
        <div className="MainCities">
          ...
          <div className="CitiesRight">
            <CitiesRight
              ...
              ProgramBot1="Learnbay offers a Data Science course in Bangalore, the most comprehensive Data Science course in the market, covering the complete Data Science lifecycle concepts from Data Collection to Data Visualization and deploying the solution to the customer."
              ProgramBot2="Learnbay is considered the best data science training institute in Bangalore, with over thousands participants working in various multinational companies such as E&Y, TCS, Accenture, Amazon, Infosys, IBM etc. Our faculties are industrial experts from top-notch MNCs. They share their experience and knowledge throughout their offline and online Data science courses. The courses are custom-designed for learners who want to shift into a Data Science Career, even after working in any domain for years. In one word, it's the ultimate destination where you can find the best foundational and advanced Data science courses in Bangalore for working professionals."
              ProgramBot3="The Learnbay Data science course training for working professionals in Bangalore implies practical knowledge and theoretical concepts for balanced learning. This institute offers the best value in Data Science certification programs available across Bangalore. So that aspirants can build a strong future in data science. Learnbay Data Science training in Bangalore is created and designed to meet industrial and organizational needs changes."
