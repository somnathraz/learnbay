      ...
      <main>
        ...
        <div className="MainCities">
          ...
          <div className="CitiesRight">
            <CitiesRight
              ProgramHead1="Data Science Course Training In Bangalore"
              ProgramBot1="Learnbay offers a Data Science course in Bangalore, the most comprehensive Data Science course in the market, covering the complete Data Science lifecycle concepts from Data Collection, Data Extraction, Data Exploration, Data Cleansing, Feature Engineering, Data Transformation, Data Integration, Data Mining, building Prediction models, Data Visualization and deploying the solution to the customer. Skills and tools ranging from Statistical Analysis, Hypothesis Testing, Text Mining, Regression Modelling, Machine Learning, Predictive Analytics, Deep Learning, Neural Networks, Predictive Modelling, Natural Language Processing, Hadoop, R Studio, Tableau, Spark, programming languages like Python and R programming, are covered extensively as part of this Data Science training."
              ProgramBot2="Learnbay is considered the best Data Science training institute in Bangalore, which offers services from Data science training to placement assistance. As part of the Data Science training program with thousands of participants working in various multinational companies such as E&Y, TCS, Accenture, Amazon, Infosys, IBM, etc. Learnbay provides the best Data Science training in Bangalore and is considered the best in the industry. Our faculties are industrial experts from top-notch MNCs. They share their experience and knowledge throughout their offline and online Data science courses. The courses are custom-designed for learners who want to shift into a Data Science Career, even after working in any domain for years. In one word, it's the ultimate destination where you can find the best foundational and advanced Data science courses in Bangalore for working professionals. The Data science course for working professionals in Bangalore implies practical knowledge and theoretical concepts for balanced learning. This institute offers the best value in Data Science certification programs available across Bangalore. So that aspirants can build a strong future in data science. Data Science training in Bangalore is created and designed to meet industrial and organizational needs changes."
              ProgramHead4="Why choose Learnbay for your data science training in Bangalore?"
              ProgramBot4="Here, you get hassle-free live classes and multiple instructors. You also get a Data science course with a placement assistance and IBM certification. Learnbay offers flexible subscriptions and access to any batches and instructors at your convenience. You can even attend multiple sessions with different instructors. All of their Data science courses in Bangalore has 1 on 1 live doubt clearance sessions from experienced FAANG Data scientists. Learners can pause, continue and complete their course within one to three years (timeline varies from course to course) after enrollment. Learnbay's unique cloud lab feature provides access to live Data science projects from MNCs and even offers guidance from industrial leads."
              ...
              ModuleBot2="Learnbay faculties help you to operate Data science tools. The tools can be Oracle, Database, MYSQL, SQL server, or Teradata. Our experts teach you how to use your probability, statistics, and mathematical analysis skills. At Learnbay, you master R, Python, and SAS; these are the few tools for analyzing data. Learn Python, Statistics, Machine learning, Advance Excel, SQL, MONGO-DB, TABLEAU, POWER BI, BIG DATA, SPARK ANALYTICS, and TIME SERIES. These are the programs you will learn to work with while completing your data science course in Bangalore."
