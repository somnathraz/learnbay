  ...
  return (
   ...
   "organizer": {
        ...
        <div className="MainCities">
          ...
          <div className="CitiesRight">
            <CitiesRight
              ...
              ProgramHead3="Why is Learnbay the best institute for advanced data science course training in Hyderabad?"
              ProgramBot3="For a richer learning experience, Learnbay focuses on providing both practical and theoretical learning modules. Moreover, Our advanced Data science certification in Hyderabad is cost-effective and even offers an MNC interview guarantee. Besides, you can choose a data science course with a 100% job assistance at Learnbay. In case you find yourself too weak in statistics, and are unable  to cope with the difficulty of the advanced data science modules, you can opt for the Foundational data science learning module.. So Learnbay is able to fulfill every aspirant's data science learning needs in Hyderabad."
              ...
              ProgramBot4="Another factor of our data science IBM certification In Hyderabad is that you can choose from a range of Foundational or Advanced Data science courses depending on your present professional level. our all courses are organized into modules based on your previous job field."
              ...
              DomainBot2="A domain-specific Data scientists will have a much greater understanding of the domain, and the critical business challenges that must be addressed. Recruiters are seeking for domain-specific expertise.. One cannot deliver precise analytical insights without subject understanding. it's critical to select data science courses that include domain electives because, no one is able to deliver best analytical insights without the subject understanding "
              ...
              CertificationBot1="You get hassle-free classes from many professional educators when pursuing the Learnbay IBM data scientist course. In addition, you will also acquire various IBM certification in Data Science and Artificial Intelligence micro-skills.. In addition, you will be awarded an IBM Project Experience Certificate once you have mastered the capstone project included in the Hyderabad data science courses. You can earn one to eight certifications, based on your course.."
              ...
              ModuleBot2="The most significant data science submodules we teach in our courses are Python, Statistics, MongoDB, Tensorflow, Deep Learning, Time Series, Deployment GCP, and other data science technologies.ols."
    ...
    12+ Classes"
              ...
              JobBot1="Learnbay provides a dedicated career placement programme as a part of its data science course. . By the completion of the IBM Data science course, students will have received instruction in soft skills and CV preparation. Our students gain confidence before the interviews by participating in various company-specific mock interviews. Furthermore, our representatives verify that your portfolio meets industry standards and appeals to hiring Managers. In Hyderabad, you can also take a Data science course with a placement assistance. You can also claim  data science course fee refund if you cannot find a data science career role within 6 months of completing the course."
              JobBot2="Leading companies like IBM, TCS, EY, Accenture, and others have worked with us.. our Thousands students have already started working in data scientist roles in Hyderabad.."
              ProjectsHead1="Industry curated live data science projects."
              ProjectsBot1="The Learnbay premium cloud lab feature helps students understand Data Science Projects and methodologies.. Learnbay offers Advanced Data science courses in Hyderabad with a choice of 8 to 15 real-world projects in your preferred fields. This cloud lab also allows you to see and practice various data mining, data wrangling, and real MNC data projects. Students can get the chance to experience on two to three Data science capstone projects, after an IBM Project accomplishment certificate will be provided."
