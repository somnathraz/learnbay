...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
      <title>Data Analytics Course in Hyderabad | Data Analytics Training in Hyderabad</title>
<meta name="description" content="Data Analytics Course in Hyderabad. Learnbay is Advanced Data Analytics Course Training Institute in Hyderabad. Data Analytics course in Hyderabad will enhance your career" />
<meta name="Keywords" content="Data Analytics course in Hyderabad, Data Analytics training in Hyderabad, Data Analytics institute in Hyderabad, best Data Analytics institute in Hyderabad, Data Analytics course in Hyderabad, Data Analytics certification in Hyderabad, Data Analytics training institute in Hyderabad, advanced Data Analytics course in Hyderabad, Data Analytics course with placement guarantee, Data Analytics course" />
<link rel="canonical" href="https://www.learnbay.co/data-analytics-course-training-in-Hyderabad" />
...
<meta name="robots" content="ALL" />
    ...
    Alumnip4="The best in Industry offerings from both cost and curriculum wise. One advantage of joining here is you can access their resources for a lifetime, unlike others where you have accessibility only for a year or so. Most importantly, there is continuous assistance for recruitment."
          ...
          />
            <FAQNew FaqDatas={AnalyticsFaqDataH} DomainFaqDatas={AnalyticsDomainFaqDataH} PaymentFaqDatas={AnalyticsPaymentFaqDataH} CapstoneFaqDatas={AnalyticsCapstoneFaqDataH} CertificationFaqDatas={AnalyticsCertificationFaqDataH} jobFaqDatas={AnalyticsjobFaqDataH} MentorshipFaqDatas={AnalyticsMentorshipFaqDataH} SupportFaqDatas={AnalyticsSupportFaqDataH} />
        </div>
      </div>
      <CityText
