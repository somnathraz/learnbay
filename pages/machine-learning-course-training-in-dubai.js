...
import { MachineFaqDataDu, MachineDomainFaqDataDu, MachinePaymentFaqDataDu, MachineCapstoneFaqDataDu, MachineCertificationFaqDataDu, MachinejobFaqDataDu, MachineMentorshipFaqDataDu, MachineSupportFaqDataDu } from "../components/FAQ/FaqDataCity";
...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
      <title>Machine Learning Course in Dubai | Machine Learning Training in Dubai</title>
<meta name="description" content="Machine learning course in Dubai. Learnbay is Advanced Machine Learning Course Training Institute in Dubai. Machine Learning course in Dubai will enhance your career" />
<meta name="Keywords" content="Machine learning course in Dubai, Machine learning training in Dubai, Machine learning institute in Dubai, best Machine learning institute in Dubai, Machine learning course in Dubai, Machine learning certification in Dubai, Machine learning training institute in Dubai, advanced Machine learning course in Dubai, Machine learning course with placement guarantee, Machine learning course" />
<link rel="canonical" href="https://www.learnbay.co/machine-learning-course-training-in-dubai" />
<meta name="robots" content="NOODP,NOYDIR" />
<meta name="HandheldFriendly" content="true" />
<meta name="distribution" content="global" />
<meta name="copyright" content="Learnbay: Machine Learning Courses Certification Training Dubai" />
...
<meta name="robots" content="ALL" />
    ...
    Alumnip4="The best in Industry offerings from both cost and curriculum wise. One advantage of joining here is you can access their resources for a lifetime, unlike others where you have accessibility only for a year or so. Most importantly, there is continuous assistance for recruitment."
          ...
          />
            <FAQNew FaqDatas={MachineFaqDataDu} DomainFaqDatas={MachineDomainFaqDataDu} PaymentFaqDatas={MachinePaymentFaqDataDu} CapstoneFaqDatas={MachineCapstoneFaqDataDu} CertificationFaqDatas={MachineCertificationFaqDataDu} jobFaqDatas={MachinejobFaqDataDu} MentorshipFaqDatas={MachineMentorshipFaqDataDu} SupportFaqDatas={MachineSupportFaqDataDu} />
        </div>
      </div>
      <CityText
